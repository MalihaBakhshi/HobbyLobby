...
public class HomeController {
    ...
    public String rootView (@AuthenticationPrincipal User user, ModelMap model) {
        ...
        String[][] facts = { {"Rod Stewart hosted the largest ever free concert", "3"},
                            {"Singing in a group boosts mood.", "3"},
                            {"Dancers are known to be disciplined, focused and high achievers who tend to be successful students and hard workers. Research also proves that dancing also reduces stress and tension for the mind and body", "2"},
                            ...
                            {"A world record for the longest conga dance line was set by 119,986 people in Miami in 1988.", "2"},
                            {"Sketching can even improve your holistic health.", "4"},
                            {"Van Gogh has only sold one painting during his lifetime.", "4"},
                            {"Picasso believed that art is done to wash away the dust of our daily lives from our souls.", "4"},
                            {"The city of Monaco is smaller in size than Central Park in New York City", "10"},
                            {"Only 4% of all the world’s languages are spoken by 96% of its population", "10"},
                            {"San Marino has more cars in its country than people", "10"},
                            {"Hiking has been known to increase the satisfaction level of many types of freeze dried food, as well as several flavors of energy bars, up to 35 percent.", "7"},
                            {"Bears basically spend their entire lives hiking.", "7"},
                            {"Walking along all of Switzerland’s hiking trails would be the equivalent of going one-and-a-half times around the world.", "7"},
                            {"Reading can help prevent Alzheimer’s.", "8"},
                            {"In the Harvard Library, there are three books suspected to be bound in human skin.", "8"},
                            {"The word ‘mogigraphia’ means ‘writer’s cramp’.", "9"},
                            {"The word ‘colygraphia’ means ‘writer’s block’.", "9"},
                            {"The first programmer in the world was a woman. Her name was Ada Lovelace and she worked on an analytical engine back in the 1,800’s.", "5"},
                            {"Nowadays, there are over 700 different programming languages.", "5"},
                            ...
                            {"Studies indicate that surgeons who regularly play video games make 37% fewer mistakes and operate 27% faster than their peers.", "6"},
                            {"Video gamers are found to be better in multitasking, driving and navigating around the streets.", "6"},
                            {"Games provide a 23 percent gain over traditional learning.", "6"},
                            {"Video gamers are found to be better in multitasking, driving and navigating around the streets.", "6"},
                            {"The first computer virus was created in 1983.", "5"},
                            {"Elizabethan scribe Peter Bales reportedly produced a complete, handwritten copy of the Bible so small it could fit inside a walnut shell.", "9"},
                            {"The largest book ever published – “The Little Prince” – is almost 7 feet high and 10 feet wide.", "8"},
                            {"Russia is bigger than Pluto.", "10"},
                            {"Picasso believed that art is done to wash away the dust of our daily lives from our souls.", "4"} }; 
    ...
    public String home(@AuthenticationPrincipal User user, ModelMap model) {
        ...
        List<User> users = new ArrayList<>(usersName);
